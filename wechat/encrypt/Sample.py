...
if __name__ == "__main__":   
    ...
    to_xml = """ <xml>
    <ToUserName>
    <![CDATA[oia2TjjewbmiOUlr6X-1crbLOvLw]]>
    </ToUserName><FromUserName>
    <![CDATA[gh_7f083739789a]]></FromUserName>
    ...
    ret, encrypt_xml = encrypt_test.encrypt_msg(to_xml, nonce)
    ...
    <Encrypt><![CDATA[]]></Encrypt>
    </xml>"""
    decrypt_test = WXBizMsgCrypt(token, encodingAESKey, appid)
    ret, decrypt_xml = decrypt_test.decrypt_msg(from_xml, msg_sign, timestamp, nonce)
    print ret, decrypt_xml
